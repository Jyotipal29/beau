            ...
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
              <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                <ul className="list-disc list-inside space-y-8">
                  ...
                  <li>
                    <Link to="/wish" className="hover:text-sky-400 transition">
                      wish
                    </Link>
                  </li>
                </ul>
                <ul role="list" className="space-y-8">
                  <li>
                    <Link
                      to="https://www.facebook.com/people/Beau-Chic/pfbid02d7wbKYxf1PqdJbKeFWp7GkysQxmU3JRcTJygammuFLYXvg2ZDsQCLjEkBCKJJBxLl/"
                  ...
                  <li>
                    <Link
                      to="https://www.instagram.com/beau._.fashion/?igshid=MzNlNGNkZWQ4Mg%3D%3D"
                      className="flex items-center space-x-3 hover:text-sky-400 transition"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                <span className="block text-gray-300">
                  Our brand is dedicated to delivering high-quality garments
                  that combine style, comfort, and affordability, catering to
                  the diverse tastes and preferences of our customers
                </span>
